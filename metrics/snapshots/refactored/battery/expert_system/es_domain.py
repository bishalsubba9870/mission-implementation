"""GPS, propulsion, communication, wind, and battery knowledge base."""
...
GPS_FAILURE_PRIORITY = 3
GPS_RECOVERY_PRIORITY = 4
GPS_LOST_PRIORITY = 5

COMMUNICATION_FAILURE_PRIORITY = 6
COMMUNICATION_RECOVERY_PRIORITY = 7
COMMUNICATION_LOST_PRIORITY = 8

WIND_UNSAFE_PRIORITY = 9
SAFE_LAND_PRIORITY = 10
SAFE_TERMINATION_PRIORITY = 11
...
def battery_critical(
    ...
    """Match critical battery condition."""
...
def build_knowledge_base() -> list[Rule]:
    """Build battery-stage production-rule knowledge base."""
