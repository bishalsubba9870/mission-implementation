"""GPS, propulsion, communication, wind, and battery Expert System executor."""
...
class ExpertSystemExecutor(Node):
    ...
    def _start_wait(
        ...
        """Start a waiting recovery state."""
    ...
    def _start_recovery_action(
        ...
        reason = self.working_memory.get(
            "termination_reason",
            "",
        )
    ...
    def _finish_abort(self) -> None:
        """Complete abort and request safe landing."""
