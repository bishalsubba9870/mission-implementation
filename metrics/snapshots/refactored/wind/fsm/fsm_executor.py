"""FSM executor with GPS, propulsion, communication, and wind handling."""
...
class FSMExecutor(Node):
    ...
    def _add_nominal_transitions(
        ...
        """Add nominal and navigation runtime transitions."""
    ...
    def _begin_navigation_recovery(
        ...
        """Interrupt navigation and enter a recovery transition."""
    ...
    def _handle_gps_available(self) -> None:
        """Resume after successful GPS recovery."""
    ...
    def _handle_gps_recovery_failed(
        ...
        """Handle unsuccessful GPS recovery."""
    ...
    def _handle_wind_unsafe(self) -> None:
        """Abort and land after unsafe wind."""
