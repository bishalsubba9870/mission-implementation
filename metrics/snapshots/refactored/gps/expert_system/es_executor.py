"""GPS-capable Expert System executor."""
...
class ExpertSystemExecutor(Node):
    ...
    def _start_gps_wait(
        ...
        """Pause mission while waiting for GPS."""
    ...
    def _tick_recovery(
        ...
        """Advance the active GPS recovery action."""
    ...
    def _finish_emergency_land(
        self,
    ) -> None:
        """Complete emergency landing and terminate safely."""
    ...
    def _finish_safe(
        ...
        """Finish mission after safe recovery termination."""
    ...
    def _complete_mission(
        ...
        """Fire the normal mission-completion rule."""
    ...
    def _is_navigating(
        ...
        """Return whether a navigation task is active."""
