"""FSM mission executor with GPS recovery."""
...
class FSMExecutor(Node):
    """Execute a mission using an FSM with GPS recovery."""
    ...
    def _build_fsm(self) -> None:
        """Build nominal and GPS-recovery FSM structure."""
