"""GPS and propulsion-capable Behavior Tree mission executor."""
...
class BehaviorTreeExecutor(Node):
    ...
    def _handle_propulsion_failure(
        ...
        """Activate shared propulsion controller."""
    ...
    def _navigation_active(self) -> bool:
        """Return whether the current mission task is navigation."""
