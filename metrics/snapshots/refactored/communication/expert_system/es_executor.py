"""GPS, propulsion, and communication Expert System executor."""
...
class ExpertSystemExecutor(Node):
    ...
    def _start_current_task(self) -> None:
        """Select a production rule for the current task."""
    ...
    def _runtime_event_callback(
        ...
        if event in {
            ...
            if (
                ...
                or self.recovery_action != "WAIT_FOR_GPS"
            ):
                return
    ...
    def _start_communication_wait(self) -> None:
    ...
    def _start_recovery_action(
        ...
        """Start a terminating recovery action."""
    ...
    def _finish_recovery_action(
        ...
        """Complete recovery and request safe termination."""
    ...
    def _finish_safe(self) -> None:
        """Finish safely terminated mission."""
    ...
    def _complete_mission(self) -> None:
        """Fire normal mission completion."""
    ...
    def _log_startup(self) -> None:
        ...
        self.get_logger().info(
            "Mode: GPS + PROPULSION + COMMUNICATION"
        )
        self.get_logger().info(
            "========================================"
        )
