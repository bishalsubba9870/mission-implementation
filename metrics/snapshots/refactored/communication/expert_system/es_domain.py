"""GPS, propulsion, and communication Expert System knowledge base."""
...
def resume_after_communication(
    ...
    """Resume mission after communication restoration."""
...
def build_knowledge_base() -> list[Rule]:
    """Build communication-stage production-rule knowledge base."""
