"""Fully scenario-capable ROS2 HTN mission executor."""
...
class HTNExecutor(Node):
    """Execute a fully scenario-capable UAV mission."""
    ...
    def _runtime_event_callback(
        ...
        if event in interruption_events:
