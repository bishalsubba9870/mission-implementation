...
class MissionAction(
    ...
    def _pause_reason(self):
        ...
        if self.executor.communication_rtl_active:
            return 'COMMUNICATION_RTL'

        if (
            self.task['type'] == 'navigate'
            and self.executor.communication_loss_active
        ):
