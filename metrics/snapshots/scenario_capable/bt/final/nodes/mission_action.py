...
class MissionAction(py_trees.behaviour.Behaviour):
    ...
    def __init__(
        ...
        self.battery_pause_reported = False
        self.abort_pause_reported = False
    ...
    def update(self):
        ...
        if self.executor.battery_critical_active:

            if not self.battery_pause_reported:

                self.battery_pause_reported = True
        ...
        if self.executor.abort_requested_active:

            if not self.abort_pause_reported:

                self.abort_pause_reported = True
