...
class MissionAction(py_trees.behaviour.Behaviour):
    ...
    Runtime priorities:
        ...
        4. GPS emergency landing
        5. GPS recovery
        6. normal mission execution

    Recovery time is not counted as normal mission-action
    execution time.
    """
    ...
    def update(
        ...
        # ==========================================================
        # PRIORITY 2 — communication loss/recovery
        # ==========================================================
        ...
        # ==========================================================
        # PRIORITY 3 — GPS emergency landing
        # ==========================================================
