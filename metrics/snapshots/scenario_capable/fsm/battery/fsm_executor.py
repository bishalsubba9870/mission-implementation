...
class FSMExecutor(Node):
    ...
    def _build_fsm(self) -> None:
        ...
        self.states = {
            ...
            # Generic Return-To-Launch / Return-To-Home
            'RTL': {
                'type': 'recovery',
                'action': 'RETURN_TO_HOME',
            },

            # Generic recovery / emergency landing
            'LAND': {
                'type': 'recovery',
                'action': 'LAND',
            },

            # Generic mission abort
            'ABORT_MISSION': {
                'type': 'recovery',
                'action': 'ABORT_MISSION',
            },

            # Explicit abnormal-but-safe terminal state
        ...
        for index, state_name in enumerate(
            ...
            # Runtime conditions are currently injected
            # while a navigation state is active.
            if (
        ...
        # GPS_AVAILABLE and COMMUNICATION_RESTORED are
        # handled dynamically because their destination
        # is the navigation state that was interrupted.
    ...
    def _handle_event(
        ...
        """Perform the FSM transition associated with an event."""
    ...
    def _timer_callback(
        ...
        """Simulate completion of the active FSM state."""
        ...
        # These states wait for an external result.
        if self.current_state in {
            'GPS_RECOVERY',
            'COMM_RECOVERY',
        }:
        ...
        # ---------------------------------------------------------
        # Recovery / emergency landing completion
        # ---------------------------------------------------------
    ...
    def _runtime_event_callback(
        ...
        # =========================================================
        # Unsupported future runtime event
        # =========================================================
    ...
    # =============================================================
    # Helper: navigation state check
    # =============================================================

    def _is_navigating(
        self,
    ) -> bool:
        """Return True when the FSM is actively navigating."""
    ...
    # =============================================================
    # Helper: resume interrupted task
    # =============================================================
    ...
    def _resume_interrupted_state(
        ...
        """Resume the navigation state interrupted by recovery."""
