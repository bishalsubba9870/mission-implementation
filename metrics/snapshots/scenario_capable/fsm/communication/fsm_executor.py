...
class FSMExecutor(Node):
    ...
    def __init__(self) -> None:
        ...
        # Used when GPS or communication loss interrupts navigation.
    ...
    def _build_fsm(self) -> None:
        ...
        self.states = {
            ...
            # Generic return-to-home behavior
            'RTL': {
                'type': 'recovery',
        ...
        for index, state_name in enumerate(
            ...
            # Runtime events are injected during navigation.
            if (
        ...
        # GPS_AVAILABLE and COMMUNICATION_RESTORED are dynamic
        # transitions because their target is whichever navigation
    ...
    def _timer_callback(
        ...
        # ---------------------------------------------------------
        # Recovery states that require an external result
        # ---------------------------------------------------------
    ...
    def _runtime_event_callback(
        ...
        """Receive runtime conditions from scenario injector."""
    ...
    # =============================================================
    # Helper: check active navigation
    # =============================================================

    def _is_navigating(
        self,
    ) -> bool:
        """Return True if current state is a navigation state."""
    ...
    # =============================================================
    # Helper: resume interrupted navigation
    # =============================================================
