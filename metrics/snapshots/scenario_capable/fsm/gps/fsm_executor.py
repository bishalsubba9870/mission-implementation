...
class FSMExecutor(Node):
    ...
    def _load_mission(
        ...
        """Load and validate the mission YAML."""
    ...
    def _build_fsm(self) -> None:
        """Build nominal mission and GPS recovery states."""
    ...
    def _handle_event(
        ...
        """Handle an event through the FSM transition table."""
    ...
    def _extract_runtime_event(
        ...
        """Parse plain-string or JSON runtime events."""
