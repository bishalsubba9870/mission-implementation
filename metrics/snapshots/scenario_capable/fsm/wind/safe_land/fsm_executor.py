...
class FSMExecutor(Node):
    ...
    def _build_fsm(self) -> None:
        ...
        Current Wind experiment:
        Variant 3:
        WIND_UNSAFE -> LAND -> SAFE_TERMINATED
        """
        ...
        # ---------------------------------------------------------
        # Build states from nominal mission tasks
        # ---------------------------------------------------------
        ...
        # RTL
        #
        # Communication failure still requires:
        # RTL -> LAND
        # ---------------------------------------------------------
        ...
        # ---------------------------------------------------------
        # Generic abort state retained for Abort Requested later
        # ---------------------------------------------------------
    ...
    def _enter_state(
        ...
        # ---------------------------------------------------------
        # Abnormal but safe terminal state
        # ---------------------------------------------------------
    ...
    def _timer_callback(
        ...
        # Recovery states requiring an external result.
        if self.current_state in {
            'GPS_RECOVERY',
            'COMM_RECOVERY',
        }:
